<?php
	...
	$stmt = $mysqli->prepare("INSERT INTO kaikai (id, name, phone, email, date, timeslot) VALUES (?,?,?,?,?,?)");
	...
	$notifyUrl = $host. "/moses/book/football/locations/kaikai/notify_kaikai.php";
	$returnUrl = $host. "/moses/book/football/locations/kaikai/return_kaikai.php";
