<?php
	...
	$stmt = $mysqli->prepare("INSERT INTO kk (id, name, phone, email, date, timeslot) VALUES (?,?,?,?,?,?)");
	...
	$notifyUrl = $host. "/moses/book/football/locations/kk/notify_kk.php";
	$returnUrl = $host. "/moses/book/football/locations/kk/return_kk.php";
