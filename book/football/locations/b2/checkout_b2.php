<?php
	...
	$stmt = $mysqli->prepare("INSERT INTO b2 (id, name, phone, email, date, timeslot) VALUES (?,?,?,?,?,?)");
	...
	$notifyUrl = $host. "/moses/book/football/locations/b2/notify_b2.php";
	$returnUrl = $host. "/moses/book/football/locations/b2/return_b2.php";
