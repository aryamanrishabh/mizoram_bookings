<?php
    ...
    if(isset($_GET['date'])){
        $date = $_GET['date'];
        $success = 'success';
        $stmt = $mysqli->prepare('select * from bethesda where date=? AND payment=?');
    ...
    if(isset($_POST['submit'])){
        ...
        $id = $_POST['id'];
        $mysqli = new mysqli('localhost', 'root', '', 'football');
        $stmt = $mysqli->prepare('select * from bethesda where date=? AND timeslot=?');
            ...
            <div id="myModal" class="modal fade" role="dialog">
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="checkout_bethesda.php" method="post">
