<?php
	...
	$stmt = $mysqli->prepare("INSERT INTO folkland (id, name, phone, email, date, timeslot) VALUES (?,?,?,?,?,?)");
	...
	$notifyUrl = $host. "/moses/book/football/locations/folkland/notify_folkland.php";
	$returnUrl = $host. "/moses/book/football/locations/folkland/return_folkland.php";
